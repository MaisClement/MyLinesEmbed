            ...
            <div className="footer">
                <div className="footer-flex">
                    ...
                    <div className="column">
                        ...
                        <a href="https://icones8.fr/" target="_blank" className="linkblue"> Icones par Icones8</a> <br/>
                        <a href="https://animista.net/" target="_blank" className="linkblue"> Animations CSS par Animista </a> <br/>
                        <a href="https://train-empire.com/fr/" target="_blank" className="linkblue"> Permis par Train-Empire </a>
                    </div>
                </div>
                    <br/>
            </div>
